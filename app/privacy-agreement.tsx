      ...
      >
        <View style={styles.section}>
          ...
          <Text style={styles.sectionContent}>
            마사학은 다음의 목적을 위하여 개인정보를 처리합니다. 처리하고 있는
            ...
            2) 재화 또는 서비스 제공{"\n"}
            서비스 제공, 콘텐츠 제공, 맞춤 서비스 제공을 목적으로 개인정보를
            처리합니다.{"\n\n"}
            3) 마케팅 및 광고에의 활용{"\n"}
            신규 서비스(제품) 개발 및 맞춤 서비스 제공, 이벤트 및 광고성 정보
            제공 및 참여기회 제공을 목적으로 개인정보를 처리합니다.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionContent}>
            1) 마사학은 법령에 따른 개인정보 보유·이용기간 또는 정보주체로부터
            ...
            완료시까지{"\n"}
            - 단, 관계 법령 위반에 따른 수사·조사 등이 진행중인 경우에는 해당
            수사·조사 종료시까지
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionContent}>
            마사학은 정보주체의 개인정보를 제1조(개인정보의 처리 목적)에서 명시한
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionContent}>
            마사학은 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보
            처리업무를 위탁하고 있습니다:{"\n\n"}
            1) 클라우드 서비스 제공{"\n"}
            - 위탁받는 자: AWS(Amazon Web Services){"\n"}
            - 위탁하는 업무의 내용: 서버 호스팅 및 데이터 저장{"\n\n"}
            마사학은 위탁계약 체결시 개인정보 보호법 제26조에 따라 위탁업무
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionContent}>
            정보주체는 마사학에 대해 언제든지 다음 각 호의 개인정보 보호 관련
            권리를 행사할 수 있습니다:{"\n\n"}
            1) 개인정보 열람요구{"\n"}
            2) 오류 등이 있을 경우 정정 요구{"\n"}
            3) 삭제요구{"\n"}
            4) 처리정지 요구{"\n\n"}
            권리 행사는 마사학에 대해 개인정보 보호법 시행규칙 별지 제8호 서식에
            따라 서면, 전자우편 등을 통하여 하실 수 있으며, 마사학은 이에 대해
            지체없이 조치하겠습니다.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionContent}>
            1) 마사학은 개인정보 보유기간의 경과, 처리목적 달성 등 개인정보가
            ...
            - 파기절차: 불필요한 개인정보 및 개인정보파일은 개인정보책임자의 책임
            하에 내부방침 절차에 따라 처리합니다.{"\n"}
            - 파기방법: 전자적 파일 형태로 기록·저장된 개인정보는 기록을 재생할
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionContent}>
            마사학은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보
            처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이
            개인정보 보호책임자를 지정하고 있습니다:{"\n\n"}
            개인정보 보호책임자{"\n"}
            - 성명: 마사학 팀{"\n"}
            - 연락처: masahak@example.com{"\n\n"}
            정보주체께서는 마사학의 서비스를 이용하시면서 발생한 모든 개인정보
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.sectionContent}>
            이 개인정보 처리방침은 2024년 10월 1일부터 적용되며, 법령 및 방침에
